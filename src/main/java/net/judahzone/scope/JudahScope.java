...
public class JudahScope extends JPanel implements Live, Floating, Closeable {
	...
	static final int FFT_SIZE = WavConstants.FFT_SIZE;
	/** our transformer */
    ...
    static final Dimension SLIDER = new Dimension(100, 24);
	...
	public JudahScope(int w) {
		...
		menu.add(Gui.resize(feedback, new Dimension(150, Gui.STD_HEIGHT)));
